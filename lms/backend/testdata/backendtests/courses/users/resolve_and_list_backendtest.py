...
def test_courses_users_resolve_and_list_base(test: lms.backend.testing.BackendTest) -> None:
    ...
    test.base_request_test(test.get_backend().courses_users_resolve_and_list, test_cases)
