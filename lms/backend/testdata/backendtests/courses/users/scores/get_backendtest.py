...
def test_courses_users_scores_get_base(test: lms.backend.testing.BackendTest) -> None:
    ...
    test.base_request_test(test.get_backend().courses_users_scores_get, test_cases)
