...
def test_courses_quizzes_groups_resolve_and_list_base(test: lms.backend.testing.BackendTest):
    ...
    test.base_request_test(test.backend.courses_quizzes_groups_resolve_and_list, test_cases)
