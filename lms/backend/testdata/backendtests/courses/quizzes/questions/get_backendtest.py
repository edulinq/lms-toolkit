...
def test_courses_quizzes_questions_get_base(test: lms.backend.testing.BackendTest):
    ...
    test.base_request_test(test.backend.courses_quizzes_questions_get, test_cases)
