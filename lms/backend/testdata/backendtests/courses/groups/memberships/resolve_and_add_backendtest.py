...
def test_courses_groups_memberships_resolve_and_add_base(test: lms.backend.testing.BackendTest) -> None:
    ...
    test.base_request_test(test.get_backend().courses_groups_memberships_resolve_and_add, test_cases)
