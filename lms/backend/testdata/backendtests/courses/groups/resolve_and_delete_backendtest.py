...
def test_courses_groups_resolve_and_delete_base(test: lms.backend.testing.BackendTest) -> None:
    ...
    test.base_request_test(test.get_backend().courses_groups_resolve_and_delete, test_cases)
