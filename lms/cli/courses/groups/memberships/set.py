...
def run_cli(args: argparse.Namespace) -> int:
    ...
    return lms.cli.common.check_strict(args.strict, add_count < len(user_queries),
        f"Expected to set {len(user_queries)} memberships in group, but only added {add_count}.", 4)
