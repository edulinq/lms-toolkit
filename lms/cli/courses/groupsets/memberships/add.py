...
def run_cli(args: argparse.Namespace) -> int:
    ...
    return lms.cli.common.strict_check(config, (total_count != len(memberships)),
        f"Expected to add {len(memberships)} memberships to groupset, but added {total_count}.", 3)
